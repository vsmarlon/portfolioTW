    ...
    <div className="flex gap-4">
      ...
      <div className="min-w-0 flex-1 text-left">
        <div className={contactMetaClassName}>
          ...
          <span className="shrink-0 border border-stone-900/20 px-2 py-1 text-[11px] font-semibold uppercase tracking-[0.14em] text-[#73004c] dark:border-stone-100/20 dark:text-fuchsia-200 sm:text-right">
            {actionLabel}
          </span>
        </div>
