      ...
      <div className="editorial-container">
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          <div className="flex items-center gap-2">
            ...
            <span className="font-medium text-stone-700 dark:text-stone-300">Marlon Vargas</span>
          </div>
          ...
          <p className="font-medium text-stone-700 dark:text-stone-300">
            {t('footer.builtWith')} <Icon name="heart" className="mx-1 inline text-[#a1006b] dark:text-fuchsia-200" /> em 2024
          </p>
        </div>
        ...
        <div className="mt-4 border-t border-stone-900/15 pt-4 text-center dark:border-stone-100/15">
          <p className="text-xs uppercase tracking-wider text-stone-600 dark:text-stone-400">
            &copy; {new Date().getFullYear()} Marlon Vargas. {t('footer.rights')}
          </p>
        </div>
      </div>
    </footer>
